...
function SensorCard({ label, isGood, icon }: SensorCardProps) {
  return (
    <div
    ...
    >
      ...
      <span
        ...
        style={{ background: isGood ? "#22c55e" : "#f97316" }}
      />
      ...
      <div className="flex flex-col leading-tight">
        ...
        <span
          ...
          style={{ color: isGood ? "#4ade80" : "#fb923c" }}
        >
          {isGood ? "Connected" : "Disconnected"}
        </span>
      </div>
    </div>
  );
